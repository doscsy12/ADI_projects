...
class DGAN:
    ...
    def __init__(self, max_sequence_len: int, sample_len: int, attribute_noise_dim: int = 10, feature_noise_dim: int = 10, attribute_num_layers: int = 3,
        ...
        batch_size: int = 1024, epochs: int = 400, discriminator_rounds: int = 1, generator_rounds: int = 1, cuda: bool = True, mixed_precision_training: bool = False,
        attribute_outputs: Optional[List[Output]] = None, feature_outputs: Optional[List[Output]] = None, verbose= False
    ):
